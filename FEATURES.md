...
| `7.1/tools/mirror` | Tools: mirror | not started | ForgeSketch | — | — |  |
| `7.1/tools/mirror/static-dynamic` | ↳ static + dynamic | not started | ForgeSketch | — | — |  |
| `7.1/tools/linear-circular-sketch-patterns` | Tools: linear/circular sketch patterns | not started | ForgeSketch | — | — |  |
| `7.1/tools/move-copy-rotate-scale-stretch` | Tools: move/copy/rotate/scale/stretch | not started | ForgeSketch | — | — |  |
