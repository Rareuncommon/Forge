...
| `7.1/tools/trim` | Tools: trim | in progress | ForgeSketch | Tests/ForgeSketchTests/SolverTests.swift, Tests/ForgeCommandsTests/SketchCommandTests.swift, Tests/GoldenModelTests/Models/018_trimmed_circle_segment.json | execute:sketch.trim | lines, arcs, circles, ellipses, partial ellipses; splines NOT IMPLEMENTED; not yet a feature-tree item (M2) |
